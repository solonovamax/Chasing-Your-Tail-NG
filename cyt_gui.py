...
class CYTGui:
    ...
    def update_status(self):
        ...
        threading.Thread(target=self.__update_status_background, daemon=True).start()

    def __update_status_background(self):
    ...
    def check_status_threaded(self):
        ...
        threading.Thread(target=self.__check_status_background, daemon=True).start()

    def __check_status_background(self):
    ...
    def create_ignore_lists_threaded(self):
        ...
        threading.Thread(target=self.__create_ignore_lists_background, daemon=True).start()

    def __create_ignore_lists_background(self):
    ...
    def run_cyt_threaded(self):
        ...
        threading.Thread(target=self.__run_cyt_background, daemon=True).start()

    def __run_cyt_background(self):
    ...
    def analyze_logs_threaded(self):
        ...
        threading.Thread(target=self.__analyze_logs_background, daemon=True).start()

    def __analyze_logs_background(self):
    ...
    def surveillance_analysis_threaded(self):
        ...
        threading.Thread(target=self.__surveillance_analysis_background, daemon=True).start()

    def __surveillance_analysis_background(self):
